...
for seed in np.arange(300, 310):
    ...
    print(seed, predicting['testing_error'])
...
x_data = predicting['states'].transpose()[0:10000, :]
...
%time rossler_spectrum = lyaps_spec.lyapunov_spectrum(rossler_data, d, h, "ordinary", steps_trans_ros, jacobian_rossler)
