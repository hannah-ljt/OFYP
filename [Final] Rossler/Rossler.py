...
import sys
sys.path.append('Users/Henrik/Documents/Hannah/[Final] Rossler')
...
rossler_esn_spectrum = lyaps_spec.lyapunov_spectrum(esn_data, N, h, "difference", 0, jacobian_esn_func)
